# Jetti Joshi — Digital Marketing Portfolio

A single-page, animated portfolio website for a Digital Marketing Executive, built with plain HTML/CSS/JS (no build step required).
...
- Sections: Home, About, Expertise, Skills, Experience Timeline, Process, Case Studies, Certificates, Contact
...
## ✏️ Customization
- Update contact details, resume link, and social links directly inside `index.html`.
